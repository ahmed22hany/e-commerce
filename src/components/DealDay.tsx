import { Box, Center, Flex, Image, Text, Link, Button, useMediaQuery } from '@chakra-ui/react'
...
const DealDay = () => {
    const [isSmallerThan980] = useMediaQuery('(min-width: 980px)');
    return (
        <>
            {
                isSmallerThan980
                    ...
                    <Box px={'5'} my={'100px'}>
                        <Flex gap={10} flexDirection={'column'}>
                            ...
                            <Box width={'100%'} padding={'30px'} borderStyle={'solid'} borderWidth={'4px'} borderColor={'#ccc'} bgGradient='linear(to-b, #FFFFFF, #F5F5F5)'>
                                <Center>
                                    <Flex flexDirection={'column'}>
                                        <Image src='https://opencart.templatemela.com/OPC10/OPC100247/OPC1/image/catalog/Cms-1.png' />
                                        <Box display={'flex'} alignItems={'center'} justifyContent={'center'} fontSize={'30px'}> <BsApple />
